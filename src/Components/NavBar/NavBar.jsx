    ...
    <div className="bg-mainColor w-full text-white max-xl:padding-x fixed z-50 top-0 ">
      <nav className="flex justify-between items-center max-container">
        ...
        <div
          className={
            menuIcon
              ? "flex items-center gap-14 max-lg:text-[15px] max-ml:flex-col max-ml:items-center max-ml:justify-center max-ml:absolute max-ml:right-0 max-ml:top-[70px] max-ml:w-full  max-ml:py-16 max-ml:gap-5 menuList"
              : "flex items-center gap-14 max-lg:text-[15px] max-ml:flex-col max-ml:items-center max-ml:justify-center max-ml:absolute max-ml:right-0 max-ml:top-[70px] max-ml:w-full  max-ml:py-16 max-ml:gap-5 menuList close"
          }
        >
          ...
          <div className="">
            <ul className="tracking-wider font-medium text-xl">
              {registerBtnList}
            </ul>
          </div>
        </div>
