    ...
    <div className="relative top-[70px] bg-pale-blue w-full h-[100%] p-7">
      <div className="bg-white max-container m-auto p-5 rounded-3xl">
        ...
        <div className="flex justify-between items-center max-ms:flex-col max-ms:gap-3">
          <div
            className="flex gap-3 justify-between items-center bg-pale-blue px-8 py-3 max-ms:w-full"
            data-aos="fade-right"
          >
        ...
        <div className="flex justify-between items-center gap-20 max-ml:flex-col max-ml:gap-6 mt-10">
          <div
            className="max-w-[500px] max-ml:max-w-[100%] w-full border border-slate-gray rounded-sm"
            data-aos="fade-right"
          >
            <iframe
            ...
            <div className="mt-6 contact-form">
              <form action="" method="post">
                ...
                <textarea
                  ...
                  rows="10"
                  placeholder="message"
                  className="mt-4 border focus:outline-none p-2 rounded-lg"
                ></textarea>
                <div>
                  <input
                    type="submit"
                    value="Send Message"
                    className="submitBtn w-full text-center bg-BtnBg1 hover:bg-mainColor rounded-md text-white py-3 my-3 cursor-pointer"
                  />
                </div>
              </form>
            </div>
